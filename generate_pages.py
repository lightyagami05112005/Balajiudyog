...
<a href="https://wa.me/916290746602" target="_blank" class="wa-float">
...
categories = [
    {
        "filename": "Stainless Steel and Brass Cutleries.html",
        "title": "Stainless Steel & Brass Cutleries",
        "img_dir": "brassware_steel_cutleries",
        "start_idx": 5,
        "total_pages": 14,
        "pdf": "_Balaji Udyog Brassware And Steel Cutleries  (1).pdf"
    },
    {
        "filename": "Bathroom Fittings and Accessories.html",
        "title": "Bathroom Fittings & Accessories",
        "img_dir": "bathroom_fitting",
        "start_idx": 3,
        "total_pages": 19,
        "pdf": "Balaji Udyog Bathroom Fitting (1).pdf"
    },
    {
        "filename": "Furniture Hardware and Locking Mechanism.html",
        "title": "Furniture Hardware & Locking Mechanism",
        "img_dir": "furniture_hardware",
        "start_idx": 3,
        "total_pages": 19,
        "pdf": "Balaji Udyog Furniture Hardware (1).pdf"
    }
]
...
for cat in categories:
    images_html = ""
    for i in range(cat["start_idx"], cat["total_pages"] + 1):
        # We link relatively to assets/images/products/...
        img_src = f"../../assets/images/products/{cat['img_dir']}/page_{i}.jpg"
        images_html += f'<div class="grid-item"><img src="{img_src}" alt="Product {i}" loading="lazy"></div>\n'
    
    html_content = template.format(title=cat["title"], images_html=images_html, pdf_filename=cat["pdf"])
    out_path = os.path.join(base_dir, cat["filename"])
